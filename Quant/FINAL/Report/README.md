...
| `figures/factor_comparison.png` | 四種配置的淨值走勢與風險調整報酬對照。 |
...
| `figures/holdings_tradeoff.png` | 持股檔數的取捨：越分散、風險調整報酬越好。 |
| `figures/param_heatmaps.png` | 跨參數的表現熱力圖——**鄰近參數都不錯，證明不是過擬合**。 |
