...
from src.domain.models import Order, OrderStatus, Portfolio, Trade
from src.execution.broker import BrokerAdapter, PaperBroker
...
from src.execution.sim import SimBroker
...
class ExecutionService:
    ...
    def initialize(self) -> bool:
        ...
        if mode in ("paper", "live"):
            try:
                from src.execution.sinopac_broker import SinopacBroker, SinopacConfig
