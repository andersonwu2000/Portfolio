...
export const zh: Translations = {
  ...
  alpha: {
    ...
    paperDesc: "模擬交易以即時行情驅動 Alpha 策略，透過模擬券商執行，不涉及真實資金。",
    paperRequires: "前置條件：券商 API 連線（如永豐金 Shioaji）",
    liveDesc: "實盤交易透過已連接的券商執行真實訂單。請先完成模擬交易驗證後再啟用。",
    liveRequires: "前置條件：模擬交易驗證至少 4 週",
  },
