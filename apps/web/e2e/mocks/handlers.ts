...
export const handlers = [
  ...
  http.get(`${BASE}/api/v1/system/metrics`, () =>
    HttpResponse.json({
      uptime_seconds: 9000,
      total_requests: 1234,
  ...
  // ── Portfolio ─────────────────────────────────────────────────────
  http.get(`${BASE}/api/v1/portfolio`, () =>
    HttpResponse.json({
      nav: 1_052_340.5,
      cash: 203_120.75,
  ...
  // ── Strategies ────────────────────────────────────────────────────
  http.get(`${BASE}/api/v1/strategies`, () =>
    HttpResponse.json({
      strategies: [
  ...
  // ── Risk ──────────────────────────────────────────────────────────
  http.get(`${BASE}/api/v1/risk/rules`, () =>
    HttpResponse.json([
  ...
  http.get(`${BASE}/api/v1/risk/alerts`, () =>
    HttpResponse.json([
      {
      ...
      },
      {
        ...
        threshold: 0.05,
        action_taken: "none",
        message: "Portfolio drawdown at 3.5%, approaching 5% kill switch",
      },
    ]),
  ),

  http.post(`${BASE}/api/v1/risk/kill-switch`, () =>
    HttpResponse.json({ detail: "Kill switch activated" }),
  ),

  // ── Backtest ──────────────────────────────────────────────────────
  http.post(`${BASE}/api/v1/backtest`, () =>
    HttpResponse.json({
      task_id: "test-1",
      status: "completed",
  ...
  http.get(`${BASE}/api/v1/backtest/test-1`, () =>
    HttpResponse.json({
      task_id: "test-1",
      status: "completed",
      strategy_name: "momentum",
  ...
  http.get(`${BASE}/api/v1/backtest/test-1/result`, () =>
    HttpResponse.json({
      strategy_name: "momentum",
