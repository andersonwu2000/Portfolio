export const en = {
  ...
  strategies: {
    ...
    running: "running",
    noRegistered: "No strategies registered",
  ...
  risk: {
    ...
    killConfirm: "This will stop ALL strategies and cancel ALL pending orders. Are you sure?",
    ...
    allStopped: "All strategies stopped, all orders cancelled.",
    ruleDescriptions: {
      ...
      max_order_notional: "Single-order notional limit. Rejects if the order value (qty x price) exceeds a set percentage of NAV (default 10%). Prevents a single large order from causing a sudden portfolio shift.",
  ...
  login: {
    title: "Quant Trading",
    subtitle: "Connect to your trading server",
    serverUrl: "Server URL",
    apiKey: "API Key",
    apiKeyPlaceholder: "Enter your API key",
    connect: "Connect",
    insecureWarning: "Insecure connection -- use HTTPS in production",
  },
